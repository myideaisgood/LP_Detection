...
def calc_iou(pred, gt):
    ...
    pred_box = np.array([pred[0], pred[1], pred[0] + pred[2], pred[1] + pred[3]])
    gt_box = np.array([gt[0], gt[1], gt[0] + gt[2], gt[1] + gt[3]])
